...
public class Curut5 {
    ...
    private static void deleteData() throws  IOException{
        ...
        File database = new File("src\\Project1\\KelasTerbuka\\Database.txt");
    ...
    private static void tampilkanData() throws IOException{
        ...
        try {
            fileInput = new FileReader("src\\Project1\\KelasTerbuka\\Database.txt");
    ...
    private static void cariData() throws IOException{
        ...
        try {
            File file = new File("src\\Project1\\KelasTerbuka\\Database.txt");
        } catch (Exception e){
            System.err.println("Database Tidak ditemukan");
            System.err.println("Silahkan tambah data terlebih dahoeloe");
            tambahData();
    ...
    private static void tambahData() throws IOException{
        ...
        FileWriter fileOutput = new FileWriter("src\\Project1\\KelasTerbuka\\Database.txt",true);
